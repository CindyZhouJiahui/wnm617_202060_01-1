...
const UserProfileLocationsPhotoList = templater(o=>`<img src="${o.photo}" class="market-jump" data-id="${o.market_id}">`);
const marketProfileLocationsPhotoList = templater(o=>`<img src="${o.photo}" data-id="${o.id}">`);


const makeUserProfile = (user,market,locations) =>{
return `
<div>
	...
	<div style="padding:1em">
		...
		<div class="profile-body">
			...
			<div><strong>Market</strong> ${market.length}</div>
...
const makemarketProfile = (market,locations)=>{
...
<div class="display-flex">
	...
	<div style="padding:1em">
		<div>${market.type}</div>
		<div>${market.breed}</div>
		<div class="display-flex">
			<div class="flex-none">
				<button data-toggle=".profile-head" class="form-button">More</button>
			</div>
			<div class="flex-none">
				<a href="#settings-market-profile-page" class="form-button">Edit</a>
			</div>
			<div class="flex-none">
				<a href="#" class="form-button js-delete-animal" data-id="${market.id}">Delete</a>
			</div>
		</div>
	</div>
</div>
<div class="profile-location-photos">
	${marketProfileLocationsPhotoList(locations)}
</div>
</div>
`;
}
...
<div class="display-flex animal-jump" data-id="${o.market_id}">
	<div class="flex-none">
...
const makemarketProfileInputs = (o,namespace="list-add") => {
let types = [
	['dog','Dog'],
	['cat','Cat'],
	['horse','Horse'],
